...
func _on_pause_button_pressed() -> void:
	send_request("http://127.0.0.1:5000/pause") 


func _on_resume_button_pressed() -> void:
		send_request("http://127.0.0.1:5000/resume") 


func _on_pause_and_resume_button_pressed() -> void:
	send_request("http://127.0.0.1:5000/pauseresume") 
